      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="md:col-span-2 overflow-hidden border-none shadow-lg">
              <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b">
                <CardTitle className="text-green-800">Current Traffic Status</CardTitle>
            ...
            <Card className="border-none shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b">
                <CardTitle className="text-green-800">Recommended Entry</CardTitle>
                <CardDescription>Best time to visit based on current traffic</CardDescription>
              </div>
              <CardContent className="space-y-6 p-6">
                <div className="rounded-md bg-gradient-to-r from-green-50 to-green-100 p-4 text-center">
                  <h3 className="mb-2 text-sm font-medium text-green-800">Next Safe Entry</h3>
                  <p className="text-3xl font-bold text-green-700">{recommendedEntry}</p>
                  <p className="mt-2 text-sm text-green-700">Arrive after this time for minimal waiting</p>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-md border p-3 text-center hover:bg-gray-50 transition-colors">
            ...
            <Card className="border-none shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b">
                <CardTitle className="text-green-800">Alternate Parking</CardTitle>
                <CardDescription>Suggested parking locations</CardDescription>
              </div>
              <CardContent className="space-y-4 p-6">
                <div className="rounded-md border p-4 hover:bg-gray-50 transition-colors">
          ...
          <Card className="mt-6 border-none shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b">
              <CardTitle className="text-green-800">Available Time Slots</CardTitle>
                ...
                <TabsContent value="today">
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="rounded-md border p-3 hover:bg-gray-50 transition-colors">
          ...
          <Card className="mt-6 border-none shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b">
              <CardTitle className="text-green-800">Temple Information</CardTitle>
