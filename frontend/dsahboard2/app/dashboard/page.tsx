...
export default function DashboardPage() {
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      setVisitorCount(Math.floor(Math.random() * 50) + 220) // Between 220-270
      setParkingSpots({
    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">Welcome to Kainchi Dham Traffic Management System</p>
        </div>
        ...
        <motion.div variants={item}>
          <Card className="overflow-hidden border-none shadow-md">
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-xs text-muted-foreground mt-1">{waitTime > 20 ? "Above average" : "Below average"}</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={item}>
          <Card className="overflow-hidden border-none shadow-md">
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-xs text-muted-foreground mt-1">Today's total visitors</p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="overflow-hidden border-none shadow-md">
            ...
            <CardContent className="pt-4">
              <div className="text-3xl font-bold">
                {parkingSpots.main + parkingSpots.alternate + parkingSpots.bridge}
              </div>
              <p className="text-xs text-muted-foreground mt-1">Available parking spots</p>
            </CardContent>
          </Card>
        </motion.div>
      ...
      >
        <Card className="col-span-full lg:col-span-2 border-none shadow-md overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-800/20">
            ...
            <CardDescription>Current traffic status at Kainchi Dham</CardDescription>
          </CardHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">
                    {congestionLevel < 50 ? "Low" : congestionLevel < 80 ? "Moderate" : "High"} Congestion
                  </span>
                </div>
                <span className="text-sm text-muted-foreground">{congestionLevel}%</span>
              </div>
              <Progress
              ...
              {congestionLevel > 60 && (
                <Alert className="mt-4 border-amber-200 bg-amber-50 text-amber-800 dark:border-amber-800/30 dark:bg-amber-900/20 dark:text-amber-400">
                  ...
                  <AlertDescription>
                    Traffic congestion is currently high. Consider using alternate parking or visiting during
                    recommended times.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                ...
                <div className="rounded-md border p-3 text-center">
                  ...
                  <div className="text-2xl font-bold">{Math.max(5, waitTime - 10)} min</div>
                  <p className="text-xs text-muted-foreground mt-1">Wait time</p>
                </div>
                <div className="rounded-md border p-3 text-center">
                  <h3 className="text-sm font-medium mb-1">VIP Entrance</h3>
                  <div className="text-2xl font-bold">{Math.max(2, waitTime - 20)} min</div>
                  <p className="text-xs text-muted-foreground mt-1">Wait time</p>
                </div>
              </div>
            </div>
      ...
      >
        <Card className="border-none shadow-md overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-800/20">
            ...
            <CardDescription>Available parking spots at different locations</CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <div className="space-y-6">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm">{parkingSpots.main} spots available</span>
                </div>
                <Progress
                  value={(parkingSpots.main / 50) * 100}
                  className="h-2"
                  indicatorClassName={parkingSpots.main < 10 ? "bg-red-500" : "bg-green-500"}
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm">{parkingSpots.alternate} spots available</span>
                </div>
                <Progress
                  value={(parkingSpots.alternate / 50) * 100}
                  className="h-2"
                  indicatorClassName={parkingSpots.alternate < 10 ? "bg-red-500" : "bg-green-500"}
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm">{parkingSpots.bridge} spots available</span>
                </div>
                <Progress
                  value={(parkingSpots.bridge / 20) * 100}
                  className="h-2"
                  indicatorClassName={parkingSpots.bridge < 5 ? "bg-red-500" : "bg-green-500"}
                />
              </div>
